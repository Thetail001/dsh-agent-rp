...
`;
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								...
								onClick: () => {
									...
									setBusy(true);
									setError(void 0);
									onImport(chatFile, cardFile).then(onClose, (reason) => {
		...
		function BlankRoleplayLauncher({ session, sessionId, listCharacters, readCharacter, setCharacterArchived, importCharacterFile, migrateChat, startCharacterSession, listPersonas, savePersona, deletePersona, workspaceSettings, workspaceList }) {
		...
		function RoleplayHeader({ sessionId, useProjection, useSessions, loadAvatar, renameSession, configurePreset, importPreset, managePresetLibrary, configureWorldInfo, listCharacters, readCharacter, setCharacterArchived, importCharacterFile, migrateChat, startCharacterSession, listPersonas, savePersona, deletePersona }) {
...
`;
		...
		function importHintComponent(ctx, migrateDraft) {
			return function SillyTavernImportHint({ input, inputActions, sessionId }) {
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						(chat || migration) && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							type: "button",
							style: {
								...actionStyle,
								marginLeft: "auto"
							...
							onClick: () => {
								setBusy(true);
								setError(void 0);
								migrateDraft(sessionId, attachments, inputActions).catch((reason) => {
									setError(reason instanceof Error ? reason.message : String(reason));
								}).finally(() => {
									setBusy(false);
								});
		...
		function apply(ctx) {
			...
			const createRoleplaySession = async (sourceSessionId) => {
				...
				const created = await ctx.sessions.create(workspace === void 0 ? current?.cwd === void 0 ? {} : { cwd: current.cwd } : { workspaceId: workspace.workspaceId });
				const selected = await ctx.get("connection").api.agentPresets.select({
					sessionId: created,
			...
			const startCharacterFromCurrentSession = async (sessionId, character, greetingIndex, persona) => {
			...
			const migrateChat = async (sourceSessionId, chatFile, cardFile) => {
				...
				const session = scope === void 0 ? void 0 : ctx.sessions.sessionOf(scope);
				if (session === void 0) throw new Error("新角色会话不可用");
				const request = {
					format: 0,
			...
			const migrateSillyTavernDraft = async (sourceSessionId, attachments, inputActions) => {
