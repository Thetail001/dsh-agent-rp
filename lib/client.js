...
`;
		...
		function PresetManagerDialog({ preset, onClose, onImport, onSave }) {
			...
			const visiblePromptSections = projectPresetPromptSections(prompts).flatMap((group) => {
				...
				const matchingPrompts = group.title.toLocaleLowerCase().includes(normalizedQuery) ? group.prompts : group.prompts.filter((prompt) => prompt.name.toLocaleLowerCase().includes(normalizedQuery) || prompt.identifier.toLocaleLowerCase().includes(normalizedQuery));
																...
																children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
																	...
																	children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
																		...
																		children: [
																			...
																			(prompt.contentModified || editedPromptIds.has(prompt.identifier)) && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
																				style: {
																					color,
																					fontSize: "10px",
																					opacity: .82
