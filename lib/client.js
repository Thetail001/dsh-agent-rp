...
`;
		...
		function RoleplayHeader({ sessionId, useProjection, useSessions, loadAvatar, renameSession, configurePreset, importPreset, managePresetLibrary, configureWorldInfo, importWorldInfo, listCharacters, readCharacter, setCharacterArchived, importCharacterFile, migrateChat, startCharacterSession, listPersonas, savePersona, deletePersona, applyPersona, loadModelCapabilities }) {
...
`;
		...
		function apply(ctx) {
			...
			const migrateChatFromBlankSession = async (sourceSessionId, chatFile, cardFile) => {
