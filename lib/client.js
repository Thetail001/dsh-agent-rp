...
`;
		...
		function roleplayComposerDockComponent(ctx) {
			return function RoleplayComposerDock({ inputActions, sessionId, useProjection, useSessions, useSession }) {
				...
				const rootRef = (0, react.useRef)(null);
				const statusFrameRef = (0, react.useRef)(null);
				...
				(0, react.useEffect)(() => {
					...
					const bridge = (event) => {
						const sourceFrame = [...mounted, statusFrameRef.current].find((frame) => frame?.contentWindow === event.source);
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(RoleplayStatusLine, {
						...
						statusAvailable: statusSource !== void 0,
						onOpenStatus: () => {
							setStatusOpen(true);
						}
					}), statusOpen && statusSource !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						role: "dialog",
						"aria-modal": "true",
						"aria-label": "当前状态",
						style: {
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								...
								ref: statusFrameRef,
								title: `${projection.characterName}的当前状态`,
		...
		function RoleplayStatusLine({ projection, running, statusAvailable, onOpenStatus }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					statusAvailable && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						type: "button",
