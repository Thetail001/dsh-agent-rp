...
`;
		...
		function RoleplayHeader({ sessionId, useProjection, useSessions, loadAvatar, renameSession, configurePreset, importPreset, managePresetLibrary, listCharacters, readCharacter, startCharacterSession }) {
		...
		function CharacterLibraryDialog({ currentCharacterName, listCharacters, readCharacter, onClose, onStart }) {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [selected !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
										htmlFor: "agent-rp-session-user-name",
										style: {
											display: "block",
											fontSize: "12px",
											fontWeight: 620,
										...
										children: "这段对话里，角色怎么称呼你"
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
										id: "agent-rp-session-user-name",
										value: userName,
										maxLength: 120,
										placeholder: "可稍后加入 Persona；现在可留空",
										onChange: (event) => {
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("footer", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									...
									onClick: () => {
										...
										setStarting(true);
										setError(void 0);
										onStart(selected, greetingIndex, userName.trim() || void 0).then(() => {
											setStarting(false);
											onClose();
										}, (startError) => {
											setStarting(false);
...
`;
		...
		function apply(ctx) {
			...
			const startCharacterSession = async (sessionId, character, greetingIndex, userName) => {
				const scope = ctx.sessions.scope(sessionId);
				const session = scope === void 0 ? void 0 : ctx.sessions.sessionOf(scope);
				if (session === void 0) throw new Error("当前角色会话不可用");
