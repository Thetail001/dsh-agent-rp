	...
	factory: (require) => {
		...
		function compileRegex(value) {
			try {
				...
				const flags = match[3];
				if (flags !== void 0 && flags !== "" && !/^(?!.*?(.).*?\1)[dgimsuvy]+$/u.test(flags)) return new RegExp(value);
				const pattern = match[2];
				return pattern === void 0 ? new RegExp(value) : new RegExp(pattern, flags);
			} catch (_invalidRegex) {
				return;
			}
		}
		...
		function runScripts(raw, card, placement, view, depth, userName) {
		...
		function renderCharacterDisplay(raw, card, placement, depth, userName) {
...
`;
		...
		function RoleplayHeader({ sessionId, useProjection, useSessions, loadAvatar, configurePreset }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						projection.preset !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							type: "button",
							onClick: () => {
								setPresetOpen(true);
							},
				...
				presetOpen && projection.preset !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(PresetManagerDialog, {
		...
		function PresetManagerDialog({ preset, onClose, onSave }) {
			...
			const visiblePrompts = prompts.filter((prompt) => normalizedQuery === "" || prompt.name.toLocaleLowerCase().includes(normalizedQuery) || prompt.identifier.toLocaleLowerCase().includes(normalizedQuery));
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("style", { children: presetManagerResponsiveStyle }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "提示模块" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: "顺序与开关" })]
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										style: {
											display: "flex",
										...
										children: [visiblePrompts.map((prompt) => {
										...
										}), visiblePrompts.length === 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
											style: {
												fontSize: "13px",
												opacity: .52,
												padding: "32px 10px",
		...
		function roleplayComposerDockComponent(ctx) {
			return function RoleplayComposerDock({ inputActions, sessionId, useProjection, useSessions, useSession }) {
				...
				(0, react.useEffect)(() => {
					...
					if (frontend === void 0 || frontend.regexScripts.length === 0 || projection === void 0) return;
