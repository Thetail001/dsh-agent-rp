...
`;
		...
		function cardFrameSource(source, statData) {
		...
		function CharacterAssetsSection({ detail, sessionId }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					expressions.length > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						style: {
							fontSize: "12px",
						...
						children: expressions.map((asset) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("figure", {
							style: {
								margin: 0,
								minWidth: 0
							},
		...
		function RoleplayHeader({ sessionId, useProjection, useSessions, loadAvatar, renameSession, configurePreset, importPreset, managePresetLibrary, configureWorldInfo, listCharacters, readCharacter, startCharacterSession, listPersonas, savePersona }) {
			...
			const statusSource = statusHtml === void 0 || projection.mvu === void 0 ? void 0 : cardFrameSource(statusHtml, projection.mvu.statData);
		...
		function CharacterLibraryDialog({ currentCharacterName, listCharacters, readCharacter, listPersonas, savePersona, onClose, onStart }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
					style: {
						...
						display: "grid",
						gridTemplateColumns: "minmax(210px, .78fr) minmax(330px, 1.35fr)",
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								entries?.length === 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									...
									children: "角色库还是空的。导入一张角色卡后，它会自动保存在这里"
								}),
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [selected !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
											...
											children: editingPersona ? "收起" : "新建 Persona"
										})]
									}),
									...
									personaId !== "" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
										...
										children: personas?.find((persona) => persona.id === personaId)?.description || "只有称呼，没有额外人物设定"
									}),
									editingPersona && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										...
										children: [
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
												value: personaName,
												maxLength: 120,
												placeholder: "Persona 名称（角色会这样称呼你）",
												onChange: (event) => {
											...
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
												...
												children: savingPersona ? "正在保存…" : "保存并选中"
											})
										]
									})
								] }), error !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("footer", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									...
									type: "button",
									disabled: selected === void 0 || starting,
									onClick: () => {
...
`;
		...
		function roleplayComposerDockComponent(ctx) {
			return function RoleplayComposerDock({ inputActions, sessionId, useProjection, useSessions, useSession }) {
				...
				const viewMode = useRoleplayViewMode(sessionId);
				const rootRef = (0, react.useRef)(null);
				const background = selectedBackground(useCharacterDetail(projection?.avatarLibraryId), useRoleplayBackground(sessionId));
		...
		function apply(ctx) {
			...
			const listCharacters = async () => {
				return (await characterLibraryJson()).entries;
			};
