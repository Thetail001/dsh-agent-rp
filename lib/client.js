...
`;
		...
		function TavernScriptRuntime({ ctx, inputActions, projection, runMutation, sessionId }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					...
					children: frames.flatMap((entry) => entry.source === void 0 || entry.srcDoc === void 0 ? [] : [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("iframe", {
		...
		function roleplayComposerDockComponent(ctx, runImageGeneration, runTavernMutation) {
