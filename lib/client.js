...
任一步失败、工具不可见、工作流不存在或输出路径无法确认时，不循环重试，不编造成功结果；继续正常角色回复，只在确有必要时简短说明图片未生成。`;
		...
		*/
		function PublishedRoleplayImageAsset({ image, alt }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("img", {
					src: generatedImageAssetUrl(image.jobId),
					alt,
					loading: "lazy",
					onError: () => {
						setFailed(true);
					...
					href: generatedImageAssetUrl(image.jobId, true),
					download: image.name ?? "roleplay-image",
					style: {
						...generationButtonStyle,
		...
		function PublishedRoleplayImageCard({ publication }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("article", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("header", {
					...
					children: publication.images.map((image, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(PublishedRoleplayImageAsset, {
						image,
		...
		function GenerationTail({ matched, runGeneration, rewriteTurn, continueFromTurn, runImageGeneration, sessionId, turn, useProjection, useSession }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [publishedImages.map((publication) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(PublishedRoleplayImageCard, { publication }, publication.id)), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
