...
`;
		...
		*/
		...
		const pendingRewriteDrafts = /* @__PURE__ */ new Map();
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
							...
							children: "将从这句话之前创建一条新对话。原对话不会被修改。"
						}),
...
`;
		...
		function roleplayComposerDockComponent(ctx, runImageGeneration, runTavernMutation, runTavernGeneration, runTavernPromptPreview, runTavernModelList, runTavernTrigger, runPresetConfiguration) {
			return function RoleplayComposerDock({ inputActions, sessionId, useInput, useProjection, useSessions, useSession }) {
				const summary = useSessions((state) => state.byId[sessionId]);
				const projection = roleplaySummary(summary, useProjection("agentRp"));
				...
				(0, react.useEffect)(() => {
					...
					if (pending === void 0 || draft !== "") return;
		...
		function apply(ctx) {
			...
			const launchRoleplaySession = async (request, beforeOpen) => {
			...
			const rewriteTurn = async (sourceSessionId, turn, draft) => {
				await launchRoleplaySession({
					...
					pendingRewriteDrafts.set(sessionId, draft);
				});
			};
