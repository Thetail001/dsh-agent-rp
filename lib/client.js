...
`;
		...
		function RoleplayHeader({ sessionId, useProjection, useSessions, loadAvatar, renameSession, configurePreset, importPreset, managePresetLibrary, configureWorldInfo, listCharacters, readCharacter, setCharacterArchived, startCharacterSession, listPersonas, savePersona }) {
		...
		function CharacterLibraryDialog({ currentCharacterName, listCharacters, readCharacter, setCharacterArchived, listPersonas, savePersona, onClose, onStart }) {
