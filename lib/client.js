...
`;
		...
		function RoleplayHeader({ sessionId, useProjection, useSessions, loadAvatar, configurePreset, importPreset }) {
		...
		function PresetManagerDialog({ preset, onClose, onImport, onSave }) {
			...
			const [editedPromptIds, setEditedPromptIds] = (0, react.useState)(() => /* @__PURE__ */ new Set());
			...
			const promptModified = (prompt) => prompt.content !== prompt.importedContent || prompt.attached !== prompt.importedAttached || prompt.attached && prompt.enabled !== prompt.importedEnabled || prompt.attached && attachedPositionById.get(prompt.identifier) !== prompt.importedPosition;
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										section === "prompts" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
											style: {
												display: "flex",
												gap: "5px",
												marginTop: "8px"
															...
															return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
																...
																children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
																	...
																	children: [
																		...
																		prompt.editable && prompt.content !== prompt.importedContent && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
																			type: "button",
																			onClick: () => {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
							...
							children: "导入 SillyTavern Chat Completion 预设 JSON。导入后可分别调整提示模块、正则脚本与生成参数"
						}),
