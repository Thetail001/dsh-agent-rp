...
const projectionSchema = { parse(value) {
	...
	if (record === null || typeof record !== "object" || typeof record.characterName !== "string" || typeof record.description !== "string" || typeof record.personality !== "string" || typeof record.scenario !== "string" || record.userName !== void 0 && typeof record.userName !== "string" || !validCardVersion || record.avatarAttachmentId !== void 0 && typeof record.avatarAttachmentId !== "string" || typeof record.importedMessageCount !== "number" || !Number.isSafeInteger(record.importedMessageCount) || record.importedMessageCount < 0 || typeof record.worldInfoCount !== "number" || !Number.isSafeInteger(record.worldInfoCount) || record.worldInfoCount < 0 || !validSource) throw new Error("invalid agentRp projection");
	return value;
} };
