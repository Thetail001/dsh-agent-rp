...
*/
function createCharacterCardSessionSeed(card, attachment, greetingIndex, renderedGreeting, transport = { transport: "json" }, userName, persona) {
...
const projectionSchema = { parse(value) {
	...
	if (record === null || typeof record !== "object" || typeof record.characterName !== "string" || record.originalCharacterName !== void 0 && typeof record.originalCharacterName !== "string" || typeof record.description !== "string" || typeof record.personality !== "string" || typeof record.scenario !== "string" || record.userName !== void 0 && typeof record.userName !== "string" || record.persona !== void 0 && (typeof record.persona !== "object" || record.persona === null) || !validCardVersion || record.avatarAttachmentId !== void 0 && typeof record.avatarAttachmentId !== "string" || typeof record.importedMessageCount !== "number" || !Number.isSafeInteger(record.importedMessageCount) || record.importedMessageCount < 0 || typeof record.worldInfoCount !== "number" || !Number.isSafeInteger(record.worldInfoCount) || record.worldInfoCount < 0 || record.frontend !== void 0 && (typeof record.frontend !== "object" || record.frontend === null) || record.preset !== void 0 && (typeof record.preset !== "object" || record.preset === null) || !Array.isArray(record.presetLibrary) || record.lastRequest !== void 0 && (typeof record.lastRequest !== "object" || record.lastRequest === null) || !validSource) throw new Error("invalid agentRp projection");
	return value;
} };
...
function installPersonaLibraryHttp(ctx, library) {
	ctx.effect(() => ctx.httpServer.register({
		kind: "prefix",
...
function installAgentRp(ctx, config, options = {}) {
	...
	if (registerSessionImporter !== void 0) ctx.effect(() => registerSessionImporter("dsh-agent-rp:character-card", {
		...
		async import(input, signal) {
			...
			return {
				seed: createCharacterCardSessionSeed(card, stored.ref, request.greetingIndex, greeting, transport, userName, request.persona),
				title: card.nickname?.trim() || card.name
			};
		}
